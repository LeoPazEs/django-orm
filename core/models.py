...
class Carro(models.Model):
    """
    # OneToOneField
        Cada carro só pode se relacionar com um chassi e cada chassi só pode se relacionar com um carro

    # ForeingKey 
        Cada carro tem uma montadora, mas uma montadora tem varios carros
    
    # ManyToMany 
        Um carro pode ser dirigido por varios motoristas e um motorista pode dirigir diversos carros.
    """
